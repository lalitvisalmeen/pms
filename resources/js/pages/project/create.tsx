...
import { create as createProject, store as storeProject} from '@/routes/project/index';
...
export default function Create({}){
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title = {trans("create_project")} />
            <div className="my-5 mx-7">
                <HeadingSmall title={trans("create_project")} />
            </div>
            <div className="p-6">
